...
def main(experiment):
    ...
    root = path.Path() / '..' / '..' / 'data_24hr_farhana_01_28_2022'
...
def plotHistogram(experiment):
    ...
    ax.plot(times, data_2, label='GBM', color = 'xkcd:aquamarine')

    #ax.plot(times, data_1, label='control')
    #ax.plot(times, data_2, label='GBM')
